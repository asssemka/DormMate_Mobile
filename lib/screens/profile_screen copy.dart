              ...
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    child:
                        Text('Сменить пароль', style: GoogleFonts.montserrat(color: Colors.white)),
                  ),
                  SizedBox(height: 20),
                  Container(
                      ...
                      children: [
                        ...
                        if (status.isEmpty) ...[
                          ...
                          ElevatedButton.icon(
                            ...
                            style: ElevatedButton.styleFrom(
                              backgroundColor: const Color(0xFFD50032), // фирменный цвет
                          ...
                          Text('Ваша заявка одобрена, внесите оплату и прикрепите сюда чек.',
                              style: GoogleFonts.montserrat(fontSize: 16)),
                          SizedBox(height: 12),
                          ElevatedButton(
                            onPressed: pickFile,
                            style: ElevatedButton.styleFrom(
                              backgroundColor: const Color.fromARGB(255, 76, 145, 78),
                              shape:
                                  RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
                              minimumSize: Size.fromHeight(48),
                            ),
                            child: Text('Прикрепить скрин оплаты',
                                style: GoogleFonts.montserrat(
                          ...
                          if (showUploadButton) ...[
                            ...
                            ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                backgroundColor: const Color.fromARGB(84, 84, 84, 100),
                                shape:
                                    RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
                                minimumSize: Size.fromHeight(48),
                              ),
                          ...
                          if (uploadMessage.isNotEmpty)
                            Padding(
                              ...
                              child: Text(uploadMessage,
                                  style:
                                      TextStyle(color: const Color.fromARGB(255, 103, 221, 107))),
                            ),
                          SizedBox(height: 12),
                          ElevatedButton(
